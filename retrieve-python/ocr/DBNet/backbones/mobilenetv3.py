...
class MobileNetV3(nn.Module):
    def __init__(self, n_class=1000, input_size=224, dropout=0.8, mode='small', width_mult=1.0):
        ...
        self.features = nn.ModuleList([conv_bn(3, input_channel, 2,
                                               nlin_layer=Hswish)])  # start_idx = 0: Input type (torch.cuda.FloatTensor) and weight type (torch.FloatTensor) should be the same
        self.classifier = []
    ...
    def forward(self, x):
        ...
        for stage in range(
                17):  # https://github.com/PaddlePaddle/PaddleOCR/blob/release/2.1/ppocr/modeling/backbones/det_mobilenet_v3.py
